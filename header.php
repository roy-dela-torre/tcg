  ...
  <nav class="navbar navbar-expand-xxl bg-body-tertiary">
    <div class="container-fluid">
          ...
          <div class="group d-none d-sm-flex">
            <div class="d-flex m-0">
                <div class="input-group d-flex mb-0">
                    <form method="get" class="d-flex searchform mb-0" role="search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
      ...
      <div class="group d-flex d-sm-none">
            <form role="search" method="get" class="d-flex searchform mb-0" role="search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
              <div class="form-outline">
