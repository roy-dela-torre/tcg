...
<!-- WISHLIST TABLE -->
<div
	class="shop_table cart wishlist_table wishlist_view test traditional<?php echo $no_interactions ? 'no-interactions' : ''; ?> <?php echo $enable_drag_n_drop ? 'sortable' : ''; ?> "
	...
	<div class="wishlist-items-wrapper my-wishlists">
		<div class="row">
            ...
            if ($wishlist && $wishlist->has_items()) :
                    foreach ($wishlist_items as $item) :
                            ...
                            if ($product && $product->exists()) :
                                    ?>
					<div class="col-xl-3 col-md-4 col-sm-12 yith-wcwl-row-<?php echo esc_attr($item->get_product_id()); ?>" data-row-id="<?php echo esc_attr($item->get_product_id()); ?>">
              ...
              <div class="product-thumbnail">
                ...
                <div class="card-body">
                  <div class="item-product-info">
                    <div class="item-name">
                      <h5 class="card-title">	<?php echo wp_kses_post(apply_filters('woocommerce_in_cartproduct_obj_title', $product->get_title(), $product)); ?></h5>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-xl-4 col-md-4 col-6">
                        <div class="flex-cart">
                        <?php if ($show_last_column) : ?>
                          <div class="add-to-cart-button add-to-cart-favorites">
