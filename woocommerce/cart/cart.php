...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/desktop/cart.css">
<div class="col-xxl-8 col-xl-7 col-md-12">
	<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		<?php do_action( 'woocommerce_before_cart_table' ); ?>
		<h1>Your Cart</h1>
		<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0" id="main_cart_table">
			<div class="table_head">
				...
				<div class="product-name" id="product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></div>
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<div class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<div class="product-remove d-none">
								<?php
							...
							<div class="product-subtotal d-none" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
								<?php
